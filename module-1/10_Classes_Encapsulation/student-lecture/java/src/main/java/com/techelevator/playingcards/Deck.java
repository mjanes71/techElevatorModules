...
public class Deck {
    ...
    private static final String[] ALL_SUITS = new String[]{"Hearts", "Clubs", "Spades", "Diamonds"}; //array created for the for-each loop in constructor to have some values to loop through
