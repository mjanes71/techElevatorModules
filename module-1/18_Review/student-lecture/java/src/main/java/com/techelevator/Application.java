...
public class Application {
	...
	private static final String MENU_QUIT_OPTION = "Quit";
	private static final String[] MAIN_MENU_OPTIONS = {MENU_OPTION_LIST_INDEXED_FILES, MENU_OPTION_PERFORM_SAMPLE_SEARCH, MENU_QUIT_OPTION};
	...
	public void run() {
		...
		while (!finished) {
			...
			if (selection.equals(MENU_OPTION_LIST_INDEXED_FILES)) {
				...
				handleSearchMenu();
			}else if (selection.equals(MENU_QUIT_OPTION)) {
				finished = true;
