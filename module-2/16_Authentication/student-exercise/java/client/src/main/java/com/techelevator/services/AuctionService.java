...
public class AuctionService {
    ...
    public Auction[] getAll() throws AuctionServiceException {
        ...
        try {
            auctions = restTemplate.exchange(baseUrl + "auctions", HttpMethod.GET, makeAuthEntity(), Auction[].class).getBody();
    ...
    public Auction getOne(int id) throws AuctionServiceException {
        ...
        try {
            auction = restTemplate.exchange(baseUrl + "auctions/" + id, HttpMethod.GET, makeAuthEntity(), Auction.class).getBody();
        } catch (RestClientResponseException ex) {
            throw new AuctionServiceException(ex.getRawStatusCode() + " : " + ex.getResponseBodyAsString());
        }
        return auction;
    ...
    public Auction[] getByTitle(String title) throws AuctionServiceException {
        Auction[] auctions = null;
        try {
            auctions = restTemplate.exchange(baseUrl + "auctions?title_like=" + title, HttpMethod.GET,
    ...
    public Auction[] getByPrice(double price) throws AuctionServiceException {
        Auction[] auctions = null;
        try {
            auctions = restTemplate.exchange(baseUrl + "auctions?currentBid_lte=" + price, HttpMethod.GET,
                    makeAuthEntity(), Auction[].class).getBody();
    ...
    public Auction add(String auctionString) throws AuctionServiceException {
        ...
        try {
            auction = restTemplate.postForObject(baseUrl + "auctions", makeAuctionEntity(auction), Auction.class);
        } catch (RestClientResponseException ex) {
            throw new AuctionServiceException(ex.getRawStatusCode() + " : " + ex.getResponseBodyAsString());
        }
        return auction;
    ...
    public Auction update(String auctionString) throws AuctionServiceException {
        Auction auction = makeAuction(auctionString);
        try {
            restTemplate.put(baseUrl + "auctions/" + auction.getId(), makeAuctionEntity(auction));
        } catch (RestClientResponseException ex) {
            throw new AuctionServiceException(ex.getRawStatusCode() + " : " + ex.getResponseBodyAsString());
        }
        return auction;
    ...
    public void delete(int id) throws AuctionServiceException {
        try {
            restTemplate.exchange(baseUrl + "auctions/" + id, HttpMethod.DELETE, makeAuthEntity(), String.class);
        } catch (RestClientResponseException ex) {
            throw new AuctionServiceException(ex.getRawStatusCode() + " : " + ex.getResponseBodyAsString());
        }
    }
