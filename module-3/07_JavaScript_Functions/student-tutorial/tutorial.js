...
function reduceArrayToFindProduct(arrayToMultiply) {
  return arrayToMultiply.reduce(
    (currentResult, currentElement) => {
      return currentResult * currentElement;
    }
  );
}
 ...
 * @param {string} temperatureUnit current unit of measure for temperature 
 * @param {boolean} includeUnit indicates whether or not to include the unit on the final answer
