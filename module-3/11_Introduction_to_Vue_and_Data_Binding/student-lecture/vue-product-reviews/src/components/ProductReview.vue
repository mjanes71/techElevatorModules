...
export default {
    name: "product-review",
    data() { /*same as saying data: function() {}, we make it a func with everything returned so that if we have multiple instances of this component, every one gets its own data */
        return {
