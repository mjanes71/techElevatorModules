<template>
  <div class="main">
    ...
    <div class="well-display">
      <div class="well" v-on:click="ratingFilter = 0">
    ...
    <a href="#" v-on:click.prevent.stop="showForm = false" v-else>Hide Form</a>
    <form v-on:submit.prevent="addNewReview" v-if="showForm">

      <div class="form-element">
        <label for="reviewer">Name: </label>
        <input type="text" id="reviewer" v-model.lazy.trim="newReview.reviewer"/> 
      </div>
      <div class="form-element">
